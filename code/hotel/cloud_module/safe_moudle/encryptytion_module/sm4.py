...
a=CryptSM4()
a.set_key(b"3l5butlj26hvv313", SM4_ENCRYPT)
b = a.crypt_cbc(b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" , b"12334jfdjdfajfdkafkdajfkdjakfaifdkajfjdkaljfdklafdlafdafjdfaldkjkf") #  bytes类型
print(b)
